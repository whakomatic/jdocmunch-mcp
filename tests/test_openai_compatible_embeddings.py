...
def _clear_embedding_env(monkeypatch):
    ...
    # This file tests config resolution and cache identity, not installation.
    # Mock the package-availability check so a named provider resolves whether
    # or not the dev env installs the openai SDK; the check has its own tests
