...
def packages_installed(monkeypatch):
    ...
    These tests are about the paid-cloud gate, not installation. A selected
    but uninstalled provider resolves to None for its own reason, which would
    hide the gate decision under test, and the dev env installs none of the
    cloud SDKs.
    """
